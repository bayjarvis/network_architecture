...
def run(args):
    ...
    config = model.config
    config.to_json_string = to_json_string.__get__(config)
    config.to_dict = to_dict.__get__(config)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="./data/train_v2.0.jsonl")
